                ...
                <div>
                    ...
                    <p class="mt-4 text-gray-500 text-sm leading-relaxed">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                 <tr>
                                    <td><input type="text" value="{{$products->id}}"></td>
                                    <td><input type="text" value="{{$products->categories->name}}"></td>
                                    <td><input type="text" value="{{$products->name}}"></td>
                                    <td><input type="text" value="{{$products->price}}"></td>
                                    <td><input type="text" value="{{$products->description}}"></td>
                                </tr>
                            </tbody>
                        </table>
                    </p>
